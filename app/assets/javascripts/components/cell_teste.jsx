class CellTeste extends React.Component {
  constructor(props) {
    super(props)
    this.state = {
      editing: false,
   ...
   */
  handleUnselectAll() {
    if (this.state && (this.state.selected || this.state.editing)) {
   ...
   */
  hasNewValue(value) {
    console.log("no cell", this.props);
   ...
   */
  doubleClicked() {
    console.log("doubleClicked - CellTeste")
